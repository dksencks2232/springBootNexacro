    ...
    return function(path)
    {
        ...
        */
        ...
        /**
        		 ...
        		 * @memberOf Iject
        		 */
        	  this.appOnload = function(app)
        	  {
        			var o= app;
        			MvFrameSet      = o.mainframe.VFrameSet0;                                			//VFrameSet
        			MloginFrame     = o.mainframe.VFrameSet0.loginFrame; 				   				//LoginFrame
        			MhFrame         = o.mainframe.VFrameSet0.HFrameSet0;                      			//HFrame
        			MleftFrame      = o.mainframe.VFrameSet0.HFrameSet0.LeftFrame;            			//leftFrame
        			MvFrameSet1     = o.mainframe.VFrameSet0.HFrameSet0.VFrameSet1;           			//VFrameSet1
        			MtopFrame       = o.mainframe.VFrameSet0.HFrameSet0.VFrameSet1.TopFrame;  			//TopFrame
        			MworkFrame      = o.mainframe.VFrameSet0.HFrameSet0.VFrameSet1.WorkFrame;            //WorkForm
        			MmainFrame      = o.mainframe.VFrameSet0.HFrameSet0.VFrameSet1.WorkFrame.MainForm;  //mainform
        			MmdiFrame       = o.mainframe.VFrameSet0.MDIFrame;                       			//mdi frame
        			Mhttpurl        = o.services["svcurl"].url;							  	//trnasaction service url
        			MmainframeSize  = {width: o.mainframe.width,height: o.mainframe.height};
        ...
        this.gfnLeftMenuAction = function(o,oBtn)
        {
        	...
        	if (nexacro.Browser != "Runtime")
        	{
        		...
        		var objLeft = MleftFrame.form.div_left;
        	   objLeft.set_left(10);
        		//objLeft.set_left(-50);
