(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "0", "209", "230", "40", null, null, this.div_left);
            obj.set_taborder("8");
            obj.set_cssclass("sta_LF_SearchBg");
            obj.style.set_padding("0 0 0 10");
            this.div_left.addChild(obj.name, obj);
            obj = new Grid("grd_tree", "absolute", "0", "248", "231", null, null, "0", this.div_left);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"230\"/></Columns><Rows><Row size=\"37\"/></Rows><Band id=\"body\"><Cell displaytype=\"tree\" edittype=\"tree\" style=\"padding:EXPR(lev=='1'?&quot;0 0 0 -5&quot;:&quot;&quot;);background:EXPR(lev=='1'?&quot;URL('theme://img/grd_LF_TreeBg2.png') stretch 15,15&quot;:&quot;&quot;);background2:EXPR(lev=='1'?&quot;URL('theme://img/grd_LF_TreeBg2.png') stretch 15,15&quot;:&quot;&quot;);color:EXPR(lev=='1'?&quot;#8192aaff&quot;:&quot;&quot;);color2:EXPR(lev=='1'?&quot;#8192aaff&quot;:&quot;&quot;);font:EXPR(lev=='1'?&quot;9 Gulim&quot;:&quot;&quot;);selectbackground:EXPR(lev=='1'?&quot;URL('theme://img/grd_LF_TreeBg_O.png') stretch 15,15&quot;:&quot;&quot;);selectfont:EXPR(lev=='1'?&quot;9 Gulim&quot;:&quot;&quot;);\" text=\"bind:MENU_NAME\" treestartlevel=\"1\" treelevel=\"bind:MENU_LEVEL\"/></Band></Format></Formats>");
            this.div_left.addChild(obj.name, obj);
            obj = new Button("Button02", "absolute", "115", "173", "115", "36", null, null, this.div_left);
            obj.set_taborder("4");
            obj.set_text("My Menu");
            obj.set_cssclass("btn_LF_Menu");
            this.div_left.addChild(obj.name, obj);
            obj = new Button("Button01", "absolute", "0", "173", "115", "36", null, null, this.div_left);
            obj.set_taborder("5");
            obj.set_text("Menu");
            ...
            this.div_left.addChild(obj.name, obj);
            obj = new Button("Button03", "absolute", "195", "216", "29", "25", null, null, this.div_left);
            obj.set_taborder("0");
            ...
            obj.set_treeusecheckbox("false");
            obj.set_visible("false");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"230\"/></Columns><Rows><Row size=\"37\"/></Rows><Band id=\"body\"><Cell displaytype=\"tree\" edittype=\"tree\" style=\"background:EXPR(lev=='0'?&quot;URL('theme://img/grd_LF_TreeBg.png') stretch 20,20&quot;:&quot;&quot;);background2:EXPR(lev=='0'?&quot;URL('theme://img/grd_LF_TreeBg.png') stretch 20,20&quot;:&quot;&quot;);selectbackground:EXPR(lev=='0'?&quot;URL('theme://img/grd_LF_TreeBg_O.png') stretch 20,20&quot;:&quot;&quot;);selectfont:EXPR(lev=='0'?&quot;bold 9 Gulim&quot;:&quot;&quot;);controlfont:EXPR(lev=='0'?&quot;bold 9 Gulim&quot;:&quot;&quot;);\" text=\"bind:txt\" treelevel=\"bind:lev\"/></Band></Format></Formats>");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 230, 958, this.div_left,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("2");
            		p.set_text("Div00");
